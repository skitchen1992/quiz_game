...
export class Answer1729090269637 implements MigrationInterface {
    name = 'Answer1729090269637'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "answer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."answer_status_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "question_id" uuid NOT NULL, "player_id" uuid NOT NULL, CONSTRAINT "PK_9232db17b63fb1e94f97e5c224f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "question_of_game" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "order" integer NOT NULL, "question_id" uuid NOT NULL, "game_id" uuid NOT NULL, CONSTRAINT "PK_b6cdb737a6fcfe3727afd1f1c86" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "answer" ADD CONSTRAINT "FK_c3d19a89541e4f0813f2fe09194" FOREIGN KEY ("question_id") REFERENCES "quiz_questions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
