...
export class Game1728725408336 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "game" ADD "started_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "game" ADD "finished_at" TIMESTAMP WITH TIME ZONE DEFAULT now()`);
    }
